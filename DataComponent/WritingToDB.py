    ...
    def __init__(self, name: str, target_path: str, key: str, file_format: str):
        ...
        try:
            ...
            if self.check_target_path_exists(target_path):
                ...
                logging.info('Saving to the Cloud success') #needs to be replaced by logging in the future
            else:
                logging.info(f'Partition directory {name} does not exist. We make this directory')
            ...
            logging.info('Saving to the Cloud failed') #needs to be replaced by logging in the future
